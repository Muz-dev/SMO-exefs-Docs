...
As you may know, most games nowadays are coded in C++, and Super Mario Odyssey is no exception. 
Super Mario Odyssey is written completely in C++, so to mod it, we are going to need to be able to write in C++.

Note

This guide assumes you already know basic C++. If you don't I recommend you read about these things as it will make this a lot easier: Pointers, References, Classes, Structs and calling functions. If not then I highly recommend you read through the site learncpp.com
